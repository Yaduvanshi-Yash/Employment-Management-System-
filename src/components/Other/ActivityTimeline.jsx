  ...
  return (
    <section className="panel-strong mt-8 rounded-[28px] p-6 sm:p-8">
      <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        ...
        <p className="max-w-xl text-sm text-slate-400">{subtitle}</p>
      </div>
        ...
        {items.length ? (
          items.map((item, index) => (
            <div
              ...
              className="relative rounded-[22px] border border-white/8 bg-white/4 px-5 py-4"
            >
              <div className="absolute left-0 top-0 h-full w-1 rounded-l-[22px] bg-blue-400/60" />
