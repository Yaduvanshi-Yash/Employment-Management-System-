...
const NewTask = ({ data, onAccept, onFail }) => {
  return (
    <article className="task-card panel-strong flex min-h-80 min-w-0 flex-col rounded-[24px] border-sky-300/15 bg-gradient-to-br from-sky-400/16 to-slate-900/85 p-5">
