...
const NewTask = ({ data, onAccept, onFail }) => {
  return (
    <article className="task-card panel-strong flex min-h-80 shrink-0 flex-col rounded-[24px] border-sky-300/15 bg-gradient-to-br from-sky-400/16 to-slate-900/85 p-5">
      <div className="flex items-start justify-between gap-3">
        <div className="flex flex-wrap gap-2">
          <span className="status-pill bg-sky-400/16 text-sky-100">
            {data.category}
          </span>
