...
const NewTask = ({ data, onAccept, onFail, isUpdating }) => {
  return (
    <article className="task-card task-card--new panel-strong flex min-h-80 min-w-0 flex-col rounded-[24px] border-blue-200/80 bg-gradient-to-br from-blue-50 via-white to-cyan-50 p-5">
      ...
      <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
        <button onClick={onAccept} disabled={isUpdating} className="btn-primary w-full disabled:cursor-not-allowed disabled:opacity-60">
