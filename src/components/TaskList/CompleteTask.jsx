...
const CompleteTask = ({ data, onAccept }) => {
  return (
    <article className="panel-strong flex min-h-80 w-[320px] shrink-0 flex-col rounded-[24px] border-emerald-300/15 bg-gradient-to-br from-emerald-400/16 to-slate-900/85 p-5">
